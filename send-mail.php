...
try {
    ...
    $mail->setFrom('contact@jodalsamglobal.com', $safeName); // Shows sender's name
    $mail->addReplyTo($safeEmail, $safeName); // Clicking "Reply" will reply to the sender
    ...
    // Reset FROM to company name for client confirmation
